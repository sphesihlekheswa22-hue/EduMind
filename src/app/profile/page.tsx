  ...
  return (
    <div className="min-h-screen bg-slate-950 py-8">
      <div className="max-w-4xl mx-auto px-4">
        {/* Back Button */}
        <Link href="/dashboard/student" className="inline-flex items-center gap-2 text-slate-400 hover:text-white mb-6">
            ...
            <div className="card p-6 text-center">
              ...
              <div className="relative inline-block mb-4">
                {profile?.avatar ? (
                  ...
                  <div className={`w-32 h-32 rounded-full bg-gradient-to-br ${roleColors[profile?.role || "student"]} flex items-center justify-center text-white text-4xl font-bold border-4 border-slate-700`}>
                ...
                <button
                  ...
                  className="absolute bottom-0 right-0 w-10 h-10 bg-indigo-500 hover:bg-indigo-600 rounded-full flex items-center justify-center text-white shadow-lg transition-colors"
              ...
              {profile?.bio && (
                <p className="text-slate-400 text-sm mt-4 italic">{profile.bio}</p>
              )}
            </div>

            {/* Quick Info */}
            <div className="card p-4 mt-4">
              <h3 className="text-sm font-semibold text-slate-400 mb-3">Quick Info</h3>
